...
function [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = IterationSSA(fname, N, thdim, lb, ub, MaxFEs, Pxy, Iteration)
    % FoodFitness=-inf;
    %%反向学习+DE交叉变异
    ...
    while FEs < MaxFEs || it <= Iteration
        c1 = 2 * exp(- (4 * it / Iteration) ^ 2); % Eq. (3.2) in the paper
