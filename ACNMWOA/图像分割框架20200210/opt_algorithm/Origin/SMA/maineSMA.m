...
function [gBest, gbestvalue, FEcount, etime, MaxFEs, Convergence_curve, iter] = maineSMA(Lmax1, level, Pxy, MaxFEs, Population_size, objectiveFunction, Iteration)
    ...
    if MaxFEs == 0
        [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = IterationSMA(objectiveFunction, Population_size, thdim, XVmin, XVmax, MaxFEs, Pxy, Iteration);
    else
        [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = EvolutionSMA(objectiveFunction, Population_size, thdim, XVmin, XVmax, MaxFEs, Pxy, Iteration);
    end
