% function [bestPositions,Convergence_curve]=SMA(N,MaxFEs,lb,ub,dim,fobj)
function [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = EvolutionSMA(fname, SearchAgents_no, thdim, lb, ub, MaxFEs, Pxy, Iteration)
    ...
    % MaxFEs=MaxFEs;  %Maximum number of evaluations
