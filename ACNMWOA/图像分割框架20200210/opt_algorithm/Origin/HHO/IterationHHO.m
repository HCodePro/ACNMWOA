function [Fbest, Lbest, FE, MaxFES, CNVG, iter] = IterationHHO(fname, N, thdim, lb, ub, MaxFES, Pxy, Iteration)
    dim = thdim / 2;
    Fbest = -inf;
    ...
    while fes < MaxFES || t <= Iteration
        ...
        c = 2 * (1 - (t / Iteration)); % factor to show the decreaing energy of rabbit
