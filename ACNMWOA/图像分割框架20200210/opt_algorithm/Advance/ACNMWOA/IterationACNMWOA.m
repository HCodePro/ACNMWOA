...
function [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = IterationACNMWOA(fname, SearchAgents_no, thdim, lb, ub, MaxFEs, Pxy, Iteration)
    dim = thdim / 2;
    Fbest = -inf;
    ...
    while FEs < MaxFEs || t <= Iteration
        ...
        % setCan = (Iteration - t + 1) / Iteration;
