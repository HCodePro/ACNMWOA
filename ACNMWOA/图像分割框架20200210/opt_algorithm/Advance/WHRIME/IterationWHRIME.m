function [Fbest, Lbest, FE, MaxFEs, Convergence_curve, iter] = IterationWHRIME(fname, N, thdim, lb, ub, MaxFEs, Pxy, Iteration)
    Fbest = -inf;
    dim = thdim / 2;
    ...
    while FEs < MaxFEs || Time <= Iteration
        ...
        K = K0 + floor((1 - Time / Iteration) * (K - K0));
        %%
