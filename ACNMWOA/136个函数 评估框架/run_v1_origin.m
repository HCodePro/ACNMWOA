...
%% 与原始算法进行比较
% algorithmName = {'PSO', 'WOA', 'DE', 'AVOA', 'ABC', 'HHO', 'ACOR', 'SMA', 'RUN', 'RIME'};
%% ACNMWOA
algorithmName = {'ACNMWOA', 'WOA', 'DE', 'AVOA', 'ABC', 'HHO', 'ACOR', 'SMA', 'RUN', 'RIME'};
...
dirname = ['exp_result/HCode-Origin-', algorithmName{1}, '-', algorithmName{2}, '-', timestr, '-Dim', num2str(dim)];
mkdir(dirname);
...
% Function_name_all = {'F137', 'F138', 'F139', 'F140', 'F141', 'F142', 'F143', 'F144', 'F145', 'F146'}; % CEC2019
% Function_name_all = {'F147', 'F148', 'F149', 'F150', 'F151', 'F152', 'F153', 'F154', 'F155', 'F156'}; % CEC2020
