...
function [Best_X, Convergence_curve] = RUN(N, MaxIt, lb, ub, dim, fobj)
    ...
    for fes = 1:MaxIt
        ...
        for i = 1:N
            ...
            gama = rand .* (X(i, :) - rand(1, dim) .* (ub - lb)) .* exp(-4 * fes / MaxIt);
