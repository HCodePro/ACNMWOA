...
algorithmName = {'ACNMWOA', 'ACNMWOA_1', 'ACNMWOA_2', 'ACNMWOA_3', 'ACNMWOA_4', 'ACNMWOA_5', 'ACNMWOA_6', 'WOA'};

Flod = 30;

%% perpare xlsfile
timestr = datestr(now, 'mm-dd-HH-MM');
dirname = ['exp_result/HCode-Melt-', algorithmName{1}, '-', algorithmName{2}, '-', timestr, '-Dim', num2str(dim)];
mkdir(dirname);
